...
const EVENT_SNAPSHOT_BATCH_SIZE = 10;
const EVENT_SNAPSHOT_BATCH_DELAY_MS = 1 * 60 * 1000;
...
const EVENT_HOURLY_SNAPSHOT_OFFSET_MS = 30 * 60 * 1000;
const EVENT_HYPIXEL_MAX_ATTEMPTS = 3;
const EVENT_SIGNUP_HYPIXEL_CONCURRENCY = 5;
const EVENT_LEADERBOARD_PAGE_SIZE = 20;
